...
public interface FlightRepository extends JpaRepository<Flight, Long> {
    ...
    // @Query(value = "SELECT * FROM flight WHERE airline REGEXP :regexQuery " +
    // "AND flight_start = :flightStart " +
    // "AND flight_destination = :flightDestination " +
    // "ORDER BY price ASC", nativeQuery = true)
    // List<Flight> findFlightsWithRegexp(@Param("regexQuery") String regexQuery,
    // @Param("flightStart") String flightStart,
    // @Param("flightDestination") String flightDestination);
